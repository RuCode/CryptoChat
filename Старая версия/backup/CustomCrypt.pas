...
uses
  Classes, Controls,
  Dialogs, mimemess, mimepart, pop3send, Process, smtpsend,
...
type
  ...
  public
    ...
    //Шифрование BlowFish
    function EncryptFileBf(PathToKeyOrKeyStr, OriginalFile, EncryptedFile: string): string;
    function DecryptFileBf(PathToKeyOrKeyStr, OriginalFile, DecryptedFile: string): string;
    //Base64
...
function TCustomCrypt.EncryptFile(PathToPubKey, OriginalFile, EncryptedFile:
  string): string;
begin
...
function TCustomCrypt.DecryptFile(PathToPrivKey, CipheredFile, DecodeFile: string): string;
begin
